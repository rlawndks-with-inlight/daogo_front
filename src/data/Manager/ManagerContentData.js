...
export const objManagerListContent = {
    user: sidebarObjFormat(
        ...
        'user',
        [
            columnObjFormat('아이디', 7, 'text', 'id'),
            columnObjFormat('이름', 6, 'text', 'name'),
            columnObjFormat('폰번호', 7, 'text', 'phone'),
            columnObjFormat('접근권한', 6, 'level', 'user_level'),
            columnObjFormat('스타', 8, 'number', 'star'),
            columnObjFormat('포인트', 8, 'number', 'point'),
    ...
    user_subscriptiondeposit: sidebarObjFormat(
        ...
        [
            ...
            columnObjFormat('이름', 6, 'text', 'name'),
            columnObjFormat('폰번호', 7, 'text', 'phone'),
            columnObjFormat('스타', 8, 'minus_number', 'star'),
            columnObjFormat('포인트', 8, 'minus_number', 'point'),
            columnObjFormat('ESGW', 8, 'minus_number', 'esgw'),
            columnObjFormat('티어', 6, 'tier', 'tier'),
        ],
        [],
        false,
